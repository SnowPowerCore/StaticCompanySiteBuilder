(() => {
  ...
  // esbuild-app:../templates/companySite*.html
  var require_companySite = __commonJS({
    "esbuild-app:../templates/companySite*.html"() {
    }
  });
  ...
  function resolve(path, dflt) {
    ...
    var name = tmpl?.name, templates2 = app.templates, components = app.components;
    var template = tmpl.template || templates2[name] || document.getElementById(name);
    if (!template && dflt) {
      template = templates2[dflt] || document.getElementById(dflt);
    ...
    if (isString(template) && template.startsWith("#")) {
      ...
      template = templates2[tmpl.otemplate = template.substr(1)];
    }
    if (!template) return;
  ...
  // src/components/company-site.js
  ...
  // src/entry/index.js
  var templates = __toESM(require_companySite());
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  Object.assign(app2.templates, templates);
